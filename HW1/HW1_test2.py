...
from Waveform_Gen import prop_delay, LFM, matched_filter, zero_pad, phase_delay

# R_min = 10e3     # minimum range of interest
R_max = 0.1e3    # maximum range of interest
...
x_t_rx = alpha * np.exp(1j*pha_rand) * prop_delay(x_t_abs, t_abs, tau, t_i, F_s, att, F_D, F_0)   # time delayed signal or received waveform
